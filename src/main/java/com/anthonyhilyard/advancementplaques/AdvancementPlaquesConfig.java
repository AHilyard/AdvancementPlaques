...
public class AdvancementPlaquesConfig
{
	...
	public AdvancementPlaquesConfig(ForgeConfigSpec.Builder build)
	{
		...
		whitelist = build.comment("Whitelist of advancements to show plaques for.  Leave empty to display for all.").defineList(Arrays.asList("whitelist"), () -> new ArrayList<String>(), e -> ResourceLocation.isValidResourceLocation((String)e) );
