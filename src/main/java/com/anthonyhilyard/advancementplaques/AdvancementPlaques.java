...
public class AdvancementPlaques
{
	...
	public static final ResourceLocation TEXTURE_PLAQUES = ResourceLocation.fromNamespaceAndPath(Loader.MODID, "textures/gui/plaques.png");
	public static final ResourceLocation TEXTURE_PLAQUE_EFFECTS = ResourceLocation.fromNamespaceAndPath(Loader.MODID, "textures/gui/plaqueeffect.png");

	public static final ResourceLocation TASK_COMPLETE_ID = ResourceLocation.fromNamespaceAndPath(Loader.MODID, "ui.toast.task_complete");
	public static final ResourceLocation GOAL_COMPLETE_ID = ResourceLocation.fromNamespaceAndPath(Loader.MODID, "ui.toast.goal_complete");
